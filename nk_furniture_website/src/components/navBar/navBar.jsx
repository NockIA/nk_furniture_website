...
export const NavBar = () => {
    ...
    return (
        <div className='rowContainer containerNav' style={{backgroundColor:(screenWidth < 900) && (isDeployed == true) && "white"}}>
            {(screenWidth < 900)&& (isDeployed == false) && <svg className='openedSvg' onClick={() => setIsDeployed(true)} width="20" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M20 12v2H0v-2h20zm0-6v2H0V6h20zm0-6v2H0V0h20z" fill="#FFF" fillRule="evenodd"/></svg>}
            {(screenWidth < 900) && (isDeployed == true) && <svg className='closeSvg' onClick={() => setIsDeployed(false)} width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M14.364.222l1.414 1.414L9.414 8l6.364 6.364-1.414 1.414L8 9.414l-6.364 6.364-1.414-1.414L6.586 8 .222 1.636 1.636.222 8 6.586 14.364.222z" fill="#000" fillRule="evenodd" opacity=".201"/></svg>}
            {((screenWidth < 900 && isDeployed == false ) || (screenWidth > 900)) && <div  className='logoMobilePlacement'>
            ...
            {isDeployed && <div className='rowContainer containerLinks'>
                <a href="/">home</a>
                <a href="/">shop</a>
                <a href="/">about</a>
                <a href="/">contact</a>
